...
export const BFF_AUTH_ROUTES = {
  ...
  signinEmailOtp: "/api/auth/signin/email",
  signinTotp: "/api/auth/signin/totp",
  signinRecovery: "/api/auth/signin/recovery",
  signinWebAuthnOptions: "/api/auth/signin/webauthn/options",
  signinWebAuthnVerify: "/api/auth/signin/webauthn/verify",
  ...
  me: "/api/auth/me",
  mfa: "/api/auth/mfa",
  mfaPreferred: "/api/auth/mfa/preferred",
  mfaTotpSetup: "/api/auth/mfa/totp/setup",
  mfaTotpActivate: "/api/auth/mfa/totp/activate",
  mfaTotpDeactivate: "/api/auth/mfa/totp/deactivate",
  mfaWebAuthnRegisterOptions: "/api/auth/mfa/webauthn/register/options",
  mfaWebAuthnRegister: "/api/auth/mfa/webauthn/register",
  mfaWebAuthnDetail: (id: number) => `/api/auth/mfa/webauthn/${id}`,
  mfaRecoveryCodesReveal: "/api/auth/mfa/recovery-codes/reveal",
